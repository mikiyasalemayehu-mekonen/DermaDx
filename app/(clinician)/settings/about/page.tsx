export default function AboutPage() {
  const INFO = [
    ["Product",       "DermaCare Clinical Portal"],
    ["Version",       "v4.2.1-stable"],
    ["Model Engine",  "DermNet-v7 (Transformer)"],
    ["Compliance",    "HIPAA Compliant • CE Marked"],
    ["Support Email", "support@dermacare.health"],
    ["Last Updated",  "October 2023"],
  ];

  return (
    <div className="bg-[#f4f7fb] rounded-xl p-6 flex-1 space-y-4">
      <p className="text-[10px] text-gray-400 uppercase tracking-widest font-semibold">About DermaCare</p>
      ...
      <p className="text-[10px] text-gray-400 leading-relaxed">
        DermaCare is a clinical decision support tool intended for use by licensed dermatologists and pathologists. It is not a standalone diagnostic device.
      </p>
    </div>
  );
}
